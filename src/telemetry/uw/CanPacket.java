...
//		}
	...
	*/
	...
	public PcanPacket getPCanPacket(Date createDate, int newReset) {
		copyBitsToFields();
		...
		PcanPacket pcan = new PcanPacket(createDate, id, newReset, uptime, type, canId, (byte)getLength(), data);
		return pcan;
	}
