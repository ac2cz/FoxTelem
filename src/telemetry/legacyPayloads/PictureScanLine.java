...
public class PictureScanLine implements Comparable<PictureScanLine> {
	public int pictureCounter = 0; // 8 bits unsigned - picture count indicator
	public int scanLineNumber = 0; // 6 bits unsigned 0x00 to 0x3B, where 0x00 is the top line
