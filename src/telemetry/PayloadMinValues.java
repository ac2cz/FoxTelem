...
public class PayloadMinValues extends FramePart {
	...
	public String toString() {
		...
		s = s + "MINIMUM VALUES:\n"
				...
				+ "\n"
				+ "MinTimeStampResetCount: " + Decoder.dec(getRawValue("MinTimeStampResetCount"))
				+ "\n"
				+ "MinTimestampUptime: " + Decoder.dec(getRawValue("MinTimestampUptime"))
				+ "\n"
				+ "IHUSoftErrorData: " + Decoder.dec(getRawValue("IHUSoftErrorData"))
				;
		return s;
