...
import common.Log;
import device.airspy.AirspyDevice.BoardID;
...
public class AirspyDeviceInformation
{
	...
	public void setVersion( byte[] data )
	{
		...
		{
			Log.errorDialog( "ERROR", "Error setting airspy version byte data - null:" + 
	...
	public void setPartAndSerialNumber( byte[] data )
	{
		...
		{
			Log.errorDialog("ERROR", "Error setting airspy part and serial byte data - null:" + 
					( data == null ? " TRUE" : " FALSE length:" + data.length ) );
		}
	}
