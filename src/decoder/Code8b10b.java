...
public class Code8b10b {
	...
	public static final int NOT_FRAME = /* 0fa */ 0xfa & 0x3ff;
	public static final int FRAME = /* 0fa */ ~0xfa & 0x3ff;
	
	public static final int Encode_8b10b[][] = {
		   // RD = -1 cases
		{
		   /* 00 */ 0x274,
		   /* 01 */ 0x1d4,
		...
		for (int rd=0; rd<2; rd++)
			for (int i=0; i<256; i++) {
				...
				if ((testValue & 0x3ff) == word) {				
					return (byte)i; // return the position in the lookup table where we found the code word
				}
			}
	...
	/**
	 * For test purposes.  Given a bytes, return the 10b encoded bits.
